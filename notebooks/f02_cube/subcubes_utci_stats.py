...
measurer = Measurer()
tracker = measurer.start(data_path=climate_folder)
...
climate_path = climate_folder+"utci_hourly_1996/*.nc"
...
measurer.end(tracker=tracker,
             ...
             data_path=climate_folder+"utci_hourly_1996/",
             csv_file=data_folder+f"l001_logs/utci_benchmarks_{year}.csv')
